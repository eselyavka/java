...
public abstract class HiveBaseResultSet implements ResultSet {
    ...
    public BigDecimal getBigDecimal(int columnIndex) throws SQLException {
        ...
        throw new SQLException("Illegal conversion to BigDecimal of " + val + " (" + val.getClass() + ")");
    }
    ...
    public double getDouble(int columnIndex) throws SQLException {
        try {
            ...
            throw new Exception("Illegal conversion getDouble");
        } catch (Exception e) {
            throw new SQLException("Cannot convert column " + columnIndex
    ...
    public float getFloat(int columnIndex) throws SQLException {
        try {
            ...
            throw new Exception("Illegal conversion getFloat");
        } catch (Exception e) {
            throw new SQLException("Cannot convert column " + columnIndex
    ...
    public int getInt(int columnIndex) throws SQLException {
        try {
            ...
            throw new Exception("Illegal conversion getInt");
        } catch (Exception e) {
            throw new SQLException(
    ...
    public long getLong(int columnIndex) throws SQLException {
        try {
            ...
            throw new Exception("Illegal conversion getLong");
        } catch (Exception e) {
            throw new SQLException(
    ...
    public short getShort(int columnIndex) throws SQLException {
        try {
            ...
            throw new Exception("Illegal conversion getShort");
        } catch (Exception e) {
            throw new SQLException("Cannot convert column " + columnIndex
    ...
    public Timestamp getTimestamp(int columnIndex) throws SQLException {
        ...
        throw new SQLException("Illegal conversion getTimestamp");
    }
    ...
    public void close() throws SQLException {
        throw new SQLException("Method close not supported on " + getClass());
    }
